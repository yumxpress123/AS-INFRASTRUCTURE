    ...
    <DetailsBarWrapper>
      ...
      <div>
        <ContactsWrapper href="tel:+233543201893">
          <FaPhone size={15} color="rgb(252, 113, 137)" />
          <ContactText>+919425009445</ContactText>
        </ContactsWrapper>

        <ContactsWrapper href="mailto:aljay3334@gmail.com">
          <FaEnvelope size={15} color="rgb(252, 113, 137)" />
          <ContactText>asInfrastructure@gmail.com</ContactText>
        </ContactsWrapper>
      </div>
